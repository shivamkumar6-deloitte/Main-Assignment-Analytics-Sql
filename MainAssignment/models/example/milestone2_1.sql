...
(select  na.code,y.name, na.nav as FirstNav  from {{ ref('timespan') }} y, "ANALYTICS"."MAINASSIGNEMT"."navhistory" na where na.nav_date = y.firstdate and y.code = na.code) q2 on (q1.code = q2.code);  
